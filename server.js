...
messages.unshift({
  ...
  content: `
	When the user asks for ANY file or task:
		...
		3. For Documents (PDF, DOCX, CSV): Use 'voai.generate-document'. 
		   - For PDF: Use high-quality HTML/CSS. You can use tables, professional colors, headings, links, and text highlights. Create a beautiful, corporate-style layout.
		   - For DOCX: Use 'docx' for Word files.
          ...
          try {
            ...
            if (args.type === 'pdf') {
              try {
                ...
                // Wrap in a professional template
                const finalHtml = `
                  <!DOCTYPE html>
                  <html>
                  <head>
                    ...
                    <style>
                      ...
                      h1, h2, h3, h4 { color: #1a1a1a; margin-top: 1.5em; font-weight: 700; }
                      h1 { font-size: 24pt; border-bottom: 2px solid #000; padding-bottom: 10px; margin-bottom: 20px; }
                      ...
                      blockquote { border-left: 4px solid #ddd; padding-left: 20px; color: #666; font-style: italic; margin: 20px 0; }
